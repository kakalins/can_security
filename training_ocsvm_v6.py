...
log_file_path = os.path.join(ABSOLUTE_PATH, 'models/ocsvm_summary.txt')
...
# --- Opcional: Reamostragem para testes rápidos dentro do script de treinamento ---
    ...
    output_models_file = f'models/best_ocsvm_models_{dataset}.pkl'
    ...
    plt.tight_layout()
    plt.savefig(f'plots/confusion_matrices_test_ocsvm_{dataset}.png')
    print(f"\nMatrizes de confusão para cada conjunto de features salvas em 'plots/confusion_matrices_test_ocsvm_{dataset}.png'")
    # plt.show()
    print("-" * 30)
