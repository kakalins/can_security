...
if COMPLETE_TRAINING:
  ...
  FOLD_SPLIT = 10
  RANDOM_SEED = 33
  DATASET_NAME = 'Fuzzy'  # Options: 'Fuzzy', 'Gear', 'RPM'
...
output_models_file = f'best_iforest_models_v6_{DATASET_NAME}.pkl'
...
plt.tight_layout()
plt.savefig(f'confusion_matrices_test_if_v6_{DATASET_NAME}.png')
print(f"\nMatrizes de confusão para cada conjunto de features salvas em 'confusion_matrices_test_if_v6_{DATASET_NAME}.png'")
# plt.show()
