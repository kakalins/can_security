...
# Carrega o DataFrame
df_train = pd.read_pickle(ABSOLUTE_PATH + 'dataset/preprocessed/' + DATASET_NAME + '_train.pkl')
df_val_attack = pd.read_pickle(ABSOLUTE_PATH + 'dataset/preprocessed/' + DATASET_NAME + '_val_attack.pkl')
df_test = pd.read_pickle(ABSOLUTE_PATH + 'dataset/preprocessed/' + DATASET_NAME + '_test.pkl')
...
del df_train, df_test # Libera memória
